...
import { Bell, ChevronLeft, ChevronRight, Plus, Calendar, AlertCircle, CheckCircle, X, User, List, Trash2, MessageSquare, FileText } from "lucide-react";
...
export default function MainDashboardPage({ onNavigate }: MainDashboardPageProps) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (course) {
        setSelectedCourse(course);
        navigate(`/professor-dashboard/course/${course.id}`, { replace: false });
